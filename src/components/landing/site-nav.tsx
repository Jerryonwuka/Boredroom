  ...
  return (
    <Navbar className="top-0 pt-3">
      <NavBody className="px-3 py-2">
        ...
        {/* In flow, not absolutely centred, so the links never sit under the theme toggle and buttons when the bar shrinks on scroll. */}
        <NavItems items={LINKS} className="relative inset-auto mx-4 min-w-0 flex-1 justify-center space-x-0" />
