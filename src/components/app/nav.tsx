...
import { Activity, AlarmClock, BarChart3, Bell, CalendarDays, ClipboardCheck, ClipboardList, FolderKanban, History, LayoutDashboard, ListChecks, MessageSquare, Settings, ShieldCheck, Users, UsersRound, Kanban, Video } from "lucide-react";
...
/** The sidebar list: the active item is a quiet white pill that slides between items, its icon in the accent. */
