  ...
  return (
    <>
      ...
      <div className="mb-8 grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader title="Subscriptions" description="Every organisation by what it pays." action={<Link href="/admin/billing/subscriptions" className="link-action">All</Link>} />
        ...
        <Card>
          <CardHeader title="Revenue" description="Successful payments by month, last 12 months." action={<Link href="/admin/billing/payments" className="link-action">All</Link>} />
        ...
        <Card>
          <CardHeader title="Activity" description="What happened on the platform each day, last 30 days." action={<Link href="/admin/usage" className="link-action">Detail</Link>} />
        ...
        <Card>
          <CardHeader title="Waitlist" description="Sign-ups per day and where every contact is in the funnel." action={<Link href="/admin/marketing" className="link-action">Detail</Link>} />
      ...
      <Card>
        <CardHeader title="Newest organisations" action={<Link href="/admin/organisations" className="link-action">All organisations</Link>} />
